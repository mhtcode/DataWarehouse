...
BEGIN
    ...
    SELECT 
        @StartDate = MAX(CAST(TransactionDate AS DATE))
    FROM 
	...
	BEGIN
		...
		VALUES ('LoadFactLoyaltyPointTransaction', 'FactLoyaltyPointTransaction_Transactional', 'Procedure started for date: ' + CONVERT(varchar, @CurrentDate, 101), @StartTime, 'Running');
